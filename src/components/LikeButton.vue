...
<script>
import { UNLIKE_MANGA, LIKE_MANGA } from '../graphql/mutations'
...
export default {
    ...
    computed: {
        ...
        checked: {
            get: function() {
                let manga_ids = this.user.mangas.map(manga => manga.id);            
                return manga_ids.includes(this.mangaId);
            },
            set: function(val) {
                this.checkedVal = val;
            }
